...
<?php include 'navbar_updated.php'; ?>
        ...
        <div class="student-container">
            <div class="student-list">
                <div class="title">
                    ...
                    <div>
                        <button class="btn btn-success mr-2" data-toggle="modal" data-target="#importExcelModal">
    ...
    <!-- Import Excel Modal -->
    <div class="modal fade" id="importExcelModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="importExcel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importExcel">Import Students from Excel</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <form id="importExcelForm" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                ...
                                Expected columns: A=Student Name, B=Course & Section
                            </small>
                        </div>
