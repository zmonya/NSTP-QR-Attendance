...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2026 at 09:29 AM
...
(7, 1, '2026-02-11 05:36:00', NULL, 'Late'),
(8, 5, '2026-02-10 23:44:00', NULL, 'On Time');
...
(2, 'caleb', 'bsit 4E', 'GofyhgePOc', 'GofyhgePOc', 1),
(3, 'jamo', 'bsit 4A', 'lg7Q8Xp49j', 'lg7Q8Xp49j', 1),
(4, 'andre', 'bsit 4B', 'XNHwxXbA9w', 'XNHwxXbA9w', 1),
(5, 'steven', 'bsit 4C', 'j4LyGT0mYV', 'j4LyGT0mYV', NULL),
(6, 'Jan', 'LTS 1A', 'R0ULYGX43P', NULL, 4),
...
INSERT INTO `tbl_users` (`user_id`, `username`, `email`, `password_hash`, `full_name`, `role`, `assigned_section`, `created_at`, `updated_at`, `created_by`) VALUES
(1, 'admin', 'admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'System Administrator', 'super_admin', NULL, '2026-02-09 08:30:37', '2026-02-10 02:29:22', NULL),
(2, 'CWTS', 'client2@gmail.com', '$2y$10$Wt.4NYHkw3yoU0qRjBZXEO6FfKEmSeOBf6q7k5kqcwBRSXrz4mbnW', 'CWTS', 'admin', 'CWTS 1A', '2026-02-10 02:21:10', '2026-02-11 08:01:22', NULL),
(4, 'LTS', 'client1@gmail.com', '$2y$10$XI.L.FvumL9iS2iyAwhdTOeEfPG1UuJOmDoA3R8yFnk1uqEYJA9qi', 'LTS', 'admin', 'LTS 1A', '2026-02-11 01:15:04', '2026-02-11 08:01:43', 1),
(5, 'ROTC', 'client3@gmail.com', '$2y$10$Bie4mf9QUFmo1p5cTxOmq.LIo7E2Y1c7FXyXlatFMaBy46JaXhrSO', 'ROTC', 'admin', 'Alpha 1st', '2026-02-11 01:21:07', '2026-02-11 08:02:07', 1);
...
--
ALTER TABLE `tbl_attendance_archive`
  MODIFY `tbl_attendance_archive_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_student`
--
ALTER TABLE `tbl_student`
  MODIFY `tbl_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
